...
class Panel {
  ...
  private createPanel() {
    ...
    const checkboxesAndRadioWrapper: HTMLDivElement = Panel.wrapElements(
  ...
  private createInputTextGroup(): HTMLDivElement {
    ...
    const inputTextsGroup: HTMLDivElement = Panel.wrapElements(
  ...
  private createRadioTextGroup(): HTMLDivElement {
    ...
    const inputRadioButtonsGroup: HTMLDivElement = Panel.wrapElements(
  ...
  private createCheckboxTextGroup(): HTMLDivElement {
    ...
    const inputCheckboxesGroup: HTMLDivElement = Panel.wrapElements(
  ...
  private setMinValueSlider(newValue: string) {
    if (this.minValue) {
      let minValue = parseInt(newValue, 10);

      if (Number.isNaN(Number(minValue))) {
        minValue = 0;
      }

      if (minValue >= parseInt(this.maxValue.value, 10)) {
