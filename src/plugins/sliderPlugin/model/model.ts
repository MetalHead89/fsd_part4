 ...
 * - ModelCalculator - содержит логику расчёта данных, отвечающих за различные аспекты работы
 * слайдера, например вычисление положений бегунков или размера прогресс бара
 */
class Model {
   ...
   * @param {IThumbPosition} thumbPosition - объект с расстояниями относительно левого
   * и верхнего края родительсого контейнера
   */
   ...
   * @returns {IThumbPosition} - объект с расстояниями относительно левого
   * и верхнего края родительского контейнера
   */
