...
Отвечает за вывод слайдера на экран, а так же реагирует на пользовательский ввод и посылает через объект класса Observer уведомления об изменении, на которые подписан объект класса Presenter.
